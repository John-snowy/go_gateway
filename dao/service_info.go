...
type ServiceInfo struct {
	...
	ServiceName string    `json:"service_name" form:"service_name" description:"服务名称"`               // 服务名称
	ServiceDesc string    `json:"service_desc" form:"service_desc" description:"服务描述"`               // 服务描述
	LoadType    int       `json:"load_type" form:"load_type" description:"负载类型 0=htto 1=tcp 2=grpc"` // 类型
